          ...
          >
            <ul className="flex-col md:flex-row flex items-center md:space-x-8 mt-5 md:mt-0 md:text-sm md:font-medium">
              {navMenu
                ...
                .map(({ label, route }) => (
                  <li key={route}>
                    <NavLink to={route} className={classOfNavLink}>
                      {label}
                    </NavLink>
                  </li>
                ))}
